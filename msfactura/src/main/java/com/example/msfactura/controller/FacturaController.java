...
public class FacturaController{
    ...
    public ResponseEntity<?> listarFactura() {
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("No se logro listar las facturas, intente denuevo");
        }
    }
    ...
    public ResponseEntity<?> obtenerPorId(@PathVariable Long id){
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("No se logro obtener la factura, intente denuevo");
        }
    }
    ...
    public ResponseEntity<?> guardarFactura(@PathVariable Long idPredio,
        ...
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("No se logro guardar la factura, intente denuevo");
        }
    }
